 ...
 * @author sic-sv
 */
@Named(value = "tipoMovimientoConverter")
@Dependent
public class TipoMovimientoConverter implements Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.trim().equals("") || value.trim().equals("Seleccione uno...")) {
            ...
            try {
                ...
                TipoMov tipoMov = getTipoMovFacade().find(id);
                return tipoMov;
            } catch (Exception e) {
                throw new ConverterException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error de conversión", "No es un Tipo de movimiento válido"));
            }
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (!(value instanceof TipoMov)) {
            return null;
        }
        return String.valueOf(((TipoMov) value).getIdTipoMov());
    }
